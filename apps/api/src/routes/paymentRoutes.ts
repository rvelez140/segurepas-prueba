...
router.get(
  '/payments/intent/:paymentIntentId/status',
  paymentController.getPaymentIntentStatus.bind(paymentController)
);
router.post(
  '/payments/intent/:paymentIntentId/cancel',
...
router.delete(
  ...
  paymentController.detachPaymentMethod.bind(paymentController)
);
router.post(
  '/payments/methods/attach',
  paymentController.attachPaymentMethod.bind(paymentController)
);
