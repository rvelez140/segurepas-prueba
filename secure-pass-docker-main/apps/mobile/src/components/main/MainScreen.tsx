...
import { delToken, loadToken, saveToken, setAuthToken } from '@/services/auth.service';
...
const MainScreen: React.FC<MainScreenProps> = ({ navigation }) => {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity style={[styles.button, styles.entryButton]} onPress={handleRegistrarAcceso}>
        <Text style={styles.buttonText}>Registrar Entrada</Text>
      </TouchableOpacity>

      <TouchableOpacity style={[styles.button, styles.exitButton]} onPress={handleRegistrarSalida}>
      ...
      <TouchableOpacity style={[styles.button, styles.logoutButton]} onPress={handleLogoutRequest}>
