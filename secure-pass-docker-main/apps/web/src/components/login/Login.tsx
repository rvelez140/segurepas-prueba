      ...
      <div className={`${style.loginResidentContainer} ${style.fadein}`}>
        ...
        <div className={`${style['loginCard']}`}>
          ...
          >
            ...
            >
              <path
                d="M19.8055 10.2292C19.8055 9.55156 19.75 8.86719 19.6319 8.19531H10.2V12.0492H15.6014C15.3773 13.2911 14.6571 14.3898 13.6153 15.0875V17.5867H16.8353C18.7125 15.8328 19.8055 13.2664 19.8055 10.2292Z"
                fill="#4285F4"
              />
              <path
                d="M10.2 20C12.9 20 15.1714 19.1045 16.8389 17.5867L13.6189 15.0875C12.7403 15.6977 11.6097 16.0438 10.2036 16.0438C7.59474 16.0438 5.38809 14.2734 4.60893 11.9297H1.2793V14.5133C2.96741 17.8656 6.41951 20 10.2 20Z"
                fill="#34A853"
              />
              <path
                d="M4.60527 11.9297C4.15999 10.6878 4.15999 9.31797 4.60527 8.07605V5.49219H1.27929C-0.160651 8.33792 -0.160651 11.6688 1.27929 14.5145L4.60527 11.9297Z"
                fill="#FBBC04"
              />
              <path
                d="M10.2 3.95625C11.6819 3.93281 13.1097 4.47656 14.1889 5.48281L17.0286 2.64219C15.0786 0.792188 12.4806 -0.230469 10.2 -0.199219C6.41951 -0.199219 2.96741 1.93438 1.2793 5.49219L4.60527 8.07605C5.38076 5.72656 7.59108 3.95625 10.2 3.95625Z"
                fill="#EA4335"
              />
            </svg>
