  ...
  const exportToCSV = () => {
    ...
    try {
      ...
      if (reportData.userInfo) {
        ...
        if (reportData.userInfo.apartment)
          csvContent += `Apartamento,${reportData.userInfo.apartment}\n`;
        if (reportData.userInfo.telephone)
          csvContent += `Teléfono,${reportData.userInfo.telephone}\n`;
        csvContent += '\n';
      }
      ...
      if (stats.totalResidents !== undefined)
        csvContent += `Residentes Totales,${stats.totalResidents}\n`;
      if (stats.totalGuards !== undefined) csvContent += `Guardias Totales,${stats.totalGuards}\n`;
      if (stats.averageEntryHourGeneral)
        csvContent += `Hora Promedio de Entrada,${stats.averageEntryHourGeneral}\n`;
      if (stats.averageExitHourGeneral)
        csvContent += `Hora Promedio de Salida,${stats.averageExitHourGeneral}\n`;
      if (stats.mostFrequentEntryHour)
        csvContent += `Hora Más Frecuente de Entrada,${stats.mostFrequentEntryHour}\n`;
      if (stats.mostFrequentExitHour)
        csvContent += `Hora Más Frecuente de Salida,${stats.mostFrequentExitHour}\n`;
      if (stats.totalAuthorizations !== undefined)
        csvContent += `Autorizaciones Totales,${stats.totalAuthorizations}\n`;
      if (stats.invertalAuthorizations !== undefined)
        csvContent += `Autorizaciones en el Período,${stats.invertalAuthorizations}\n`;
      if (stats.averageVisitDuration)
        csvContent += `Duración Promedio de Visita,${stats.averageVisitDuration}\n`;
      if (stats.totalEntries !== undefined)
        csvContent += `Entradas Registradas,${stats.totalEntries}\n`;
      if (stats.intervalEntries !== undefined)
        csvContent += `Entradas en el Período,${stats.intervalEntries}\n`;
      if (stats.totalExits !== undefined) csvContent += `Salidas Registradas,${stats.totalExits}\n`;
      if (stats.intervalExits !== undefined)
        csvContent += `Salidas en el Período,${stats.intervalExits}\n`;
      csvContent += '\n';
